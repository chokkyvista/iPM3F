...
double *optimize_qp(QP *, double *, long, double *, LEARN_PARM *learn_parm);
...
int solve_dual( long n, long m, double precision, double epsilon_crit, long maxiter,
			   double *g, double *g0, double *ce, double *ce0,
			   double *low, double *up, double *primal,
			   double *d, double *d0, double *ig, double *dual, double *dual_old,
			   double *temp, long goal)
